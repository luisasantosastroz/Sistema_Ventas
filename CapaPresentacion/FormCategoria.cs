...
namespace CapaPresentacion
{
    public partial class FormCategoria : Form
    {
        ...
        private void FormCategoria_Load(object sender, EventArgs e)
        {
            ...
            List<Categoria> lista = new CN_Categotria().Listar();
        ...
        private void btnguardar_Click(object sender, EventArgs e)
        {
           ...
           Categoria obj = new Categoria()
            ...
            {
                int idgenerado = new CN_Categotria().Registrar(obj, out mensaje);
            ...
            {
                bool resultado = new CN_Categotria().Editar(obj, out mensaje);
                if (resultado)
                {
        ...
        private void btneliminar_Click(object sender, EventArgs e)
        {
            if (Convert.ToInt32(txtid.Text) != 0)
            {
                if (MessageBox.Show("¿Desea eliminar la categoría?", "Mensaje", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    bool respuesta = new CN_Categotria().Eliminar(obj, out mensaje);
