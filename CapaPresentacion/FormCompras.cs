        ...
        private void IconButton1_Click(object sender, EventArgs e)
        {
            ...
            if (!producto_existe)
            {
                dgvdata.Rows.Add(new object[]
                {
                    txtidproducto.Text,
                    txtproducto.Text,
                    preciocompra.ToString("N0", new CultureInfo("es-CO")),
                    precioventa.ToString("N0", new CultureInfo("es-CO")),
                    txtcantidad.Value.ToString(),
                    (txtcantidad.Value * preciocompra).ToString("N0", new CultureInfo("es-CO"))
                });
                calcularTotal();
                limpiarProducto();
                txtcodproducto.Select();
