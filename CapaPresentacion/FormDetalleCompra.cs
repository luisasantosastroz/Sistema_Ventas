    ...
    public partial class FormDetalleCompra : Form
    {
        ...
        private void btnbuscar_Click(object sender, EventArgs e)
        {
            ...
            if (oCompra.IdCompra != 0)
            {
                ...
                {
                    dgvdata.Rows.Add(new object[] {dc.oProducto.Nombre,
                        dc.PrecioCompra.ToString("N0", new CultureInfo("es-CO")),
                        dc.Cantidad,
                        dc.MontoTotal.ToString("N0", new CultureInfo("es-CO"))});
                }
                txtmontototal.Text = oCompra.MontoTotal.ToString("N0", new CultureInfo("es-CO"));
            }
        }
